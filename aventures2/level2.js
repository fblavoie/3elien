sprites_l = [ 
				...
				[5,2,"hide.png",[],[]],
				[2,6,"empty.png",[ 
									["ÉCRITEAU","Her Majesty the Queen of Quebec, Mary Simon."],
									["ÉCRITEAU","French description not available."],
								]
				],
				[2,7,"empty.png",[ 
									["ÉCRITEAU","Her Majesty the Queen of Quebec, Mary Simon."],
...
tiles = [
				...
				["block",3,0,"up"],["road",3,1,"up"],["road",3,2,"up"],["road",3,3,"up"],["block",3,4,"up"],["road",3,5,"up"],["road",3,6,"up"],["road",3,7,"up"],["road",3,8,"up"],["block",3,9,"up"],
				["block",4,0,"up"],["road",4,1,"up"],["road",4,2,"up"],["road",4,3,"up"],["block",4,4,"up"],["road",4,5,"up"],["road",4,6,"up"],["road",4,7,"up"],["road",4,8,"up"],["block",4,9,"up"],
				["block",5,0,"up"],["block",5,1,"up"],["road",5,2,"up"],["block",5,3,"up"],["block",5,4,"up"],["road",5,5,"up"],["block",5,6,"up"],["block",5,7,"up"],["block",5,8,"up"],["block",5,9,"up"],
...
setInterval(function(){
	if( (hero_x==6)&&(hero_y==2) ){
		const newParams = new URLSearchParams({ level: 12, data: create_data_string(), fromX: map_X, fromY: map_Y });
